...
class BasicTest {
 ...
 static String authkey = "ube96e1b5c957d36";  // Your authkey
 ...
 public JsonNode setScore(String seleniumTestId, String score) throws UnirestException {
     ...
     HttpResponse<JsonNode> response = Unirest.put("http://crossbrowsertesting.com/api/v3/selenium/myid")
 ...
 public String takeSnapshot(String seleniumTestId) throws UnirestException, JSONException {
     /*
